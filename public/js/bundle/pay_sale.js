...
}),_defineProperty(_methods,"Invoice_POS",function Invoice_POS(id){
var _this4=this;
...
_this4.GrandTotalText=_utils__WEBPACK_IMPORTED_MODULE_2__["default"].numeroALetras(_this4.formatNumber(_this4.invoice_pos.sale.GrandTotal,2));
setTimeout(function(){
// Complete the animation of the  progress bar.
nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
...
}),_defineProperty(_methods,"Update_Sale",function Update_Sale(){
var _this5=this;
...
_this5.Invoice_POS(_this5.$route.params.id);
...
}),_defineProperty(_methods,"Get_Product_Details",function Get_Product_Details(product,product_id){
var _this6=this;
...
_this6.product.Total_price=response.data.Total_price;
...
_this6.product.product_variant_id=product.product_variant_id;
_this6.product.code=product.code;

_this6.add_product(product.code);

_this6.CaclulTotal();// Complete the animation of theprogress bar.
...
_c("div",{staticClass:"col-3 "},[
_c("span",{staticClass:"text-danger"},[
_vm._v("Comprobante de credito fiscal")]),
