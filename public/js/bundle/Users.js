...
{
attrs:{
label:_vm.$t("authorizedCodeLabel")}},
...
"aria-describedby":
"NewAuthorizedCodeLabel-feedback",
placeholder:_vm.$t(
"authorizedCodeLabel"),
...
expression:"user.authorizedCode"}}),
...
_c(
"b-form-group",
{attrs:{label:_vm.$t("DefaultWarehouse")}},
[
_c("v-select",{
attrs:{
reduce:function reduce(label){
...
model:{
value:_vm.user.warehouse_id,
callback:function callback($$v){
_vm.$set(_vm.user,"warehouse_id",$$v);
},
expression:"user.warehouse_id"}})],
...
model:{
value:_vm.user.initCF,
callback:function callback($$v){
_vm.$set(_vm.user,"initCF",$$v);
},
expression:"user.initCF"}}),


_vm._v(" "),
_c(
"b-form-invalid-feedback",
{attrs:{id:"initCF-feedback"}},
[
_vm._v(
_vm._s(
validationContext.errors[0]))])],
...
model:{
value:_vm.user.finalCF,
callback:function callback($$v){
_vm.$set(_vm.user,"finalCF",$$v);
},
expression:"user.finalCF"}}),


_vm._v(" "),
_c(
"b-form-invalid-feedback",
{attrs:{id:"finalCF-feedback"}},
[
_vm._v(
_vm._s(
validationContext.errors[0]))])],
...
model:{
value:_vm.user.initCCF,
callback:function callback($$v){
_vm.$set(_vm.user,"initCCF",$$v);
},
expression:"user.initCCF"}}),


_vm._v(" "),
_c(
"b-form-invalid-feedback",
{attrs:{id:"initCCF-feedback"}},
[
_vm._v(
_vm._s(
validationContext.errors[0]))])],
