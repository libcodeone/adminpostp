...
Vue.component(
    ...
    () =>
        import(
            /* webpackChunkName: "largeSidebar" */ "./containers/layouts/largeSidebar"
        )
);
...
Vue.component(
    "login-component",
    require("./views/app/sessions/signIn.vue").default
);
Vue.component(
    "forgot-component",
    require("./views/app/sessions/forgot.vue").default
);
Vue.component(
    "reset-component",
    require("./views/app/sessions/reset.vue").default
);
