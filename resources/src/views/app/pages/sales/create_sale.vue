                        ...
                        <b-card>
                            <b-row>
                                    ...
                                    <validation-provider name="date" :rules="{ required: true }"
                                        ...
                                        <b-form-group :label="$t('date')">
                                            <b-form-input :state="getValidationState(validationContext)"
                                                ...
                                                v-model="sale.date"></b-form-input>
                                    ...
                                    <validation-provider name="Customer" :rules="{ required: true }">
                                        <b-form-group slot-scope="{ valid, errors }" :label="$t('Customer')">
                                            <v-select :class="{ 'is-invalid': !!errors.length }"
                                                ...
                                                v-model="sale.client_id" :reduce="label => label.value"
                                ...
                                <b-col lg="4" md="4" sm="12" class="mb-3">
                                    <validation-provider name="warehouse" :rules="{ required: true }">
                                        <b-form-group slot-scope="{ valid, errors }" :label="$t('warehouse')">
                                            <v-select :class="{ 'is-invalid': !!errors.length }"
                                                :state="errors[0] ? false : (valid ? true : null)"
                                                :disabled="details.length > 0" @input="Selected_Warehouse"
                                                v-model="sale.warehouse_id" :reduce="label => label.value"
                                ...
                                <b-col md="12" class="mb-5">
                                    <h6>{{ $t('ProductName') }}</h6>
                                    <autocomplete :search="search" :placeholder="$t('Search_Product_by_Code_Name')"
                                        aria-label="Search for a Product" :get-result-value="getResultValue"
                                        @submit="SearchProduct" ref="autocomplete" />
                                </b-col>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-for="detail in details">
                                                    ...
                                                    <td>{{ formatNumber(detail.Net_price, 3) }} {{ currentUser.currency }}
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-outline-warning">{{ detail.stock }}
                                                    ...
                                                    <td>{{ formatNumber(detail.DiscountNet, 2) }} {{ currentUser.currency }}
                                                    </td>
                                                    <td>{{ formatNumber(detail.taxe, 2) }} {{ currentUser.currency }}</td>
                                                    <td>{{ formatNumber(detail.subtotal, 2) }} {{ currentUser.currency }}
                                                    </td>
                                                    <td>
                                    ...
                                    <table class="table table-striped table-sm">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>{{ formatNumber(sale.TaxNet, 2) }} {{ currentUser.currency }}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="font-weight-bold">{{ formatNumber(GrandTotal, 2) }}
                                ...
                                <b-col lg="4" md="4" sm="12" class="mb-3">
                                    <validation-provider name="Order Tax" :rules="{ regex: /^\d*\.?\d*$/ }"
                                        ...
                                        <b-form-group :label="$t('OrderTax')">
                                            <b-input-group append="%">
                                                <b-form-input :state="getValidationState(validationContext)"
                                                    aria-describedby="OrderTax-feedback" label="Order Tax"
                                    ...
                                    <validation-provider name="Status" :rules="{ required: true }">
                                        <b-form-group slot-scope="{ valid, errors }" :label="$t('Status')">
                                            <v-select :class="{ 'is-invalid': !!errors.length }"
                                                ...
                                                :reduce="label => label.value" :placeholder="$t('Choose_Status')"
                                                :options="[
                                ...
                                <b-col md="4">
                                    <validation-provider name="PaymentStatus">
                                        <b-form-group :label="$t('PaymentStatus')">
                                            <v-select :reduce="label => label.value" v-model="payment.status"
                                ...
                                <b-col md="4" v-if="payment.status != 'pending'">
                                    <validation-provider name="Payment choice" :rules="{ required: true }">
                                        <b-form-group slot-scope="{ valid, errors }" :label="$t('Paymentchoice')">
                                            <v-select :class="{ 'is-invalid': !!errors.length }"
                                                :state="errors[0] ? false : (valid ? true : null)"
                                                :reduce="label => label.value" @input="Selected_PaymentMethod"
                                                v-model="payment.Reglement" :placeholder="$t('PleaseSelect')" :options="[
                                ...
                                <b-col md="4" v-if="payment.Reglement == 'credit card'">
                                    <validation-provider name="RefCreditCard"
                                        :rules="{ required: true, regex: /^\d*\.?\d*$/ }" v-slot="validationContext">
                                        <b-form-group :label="$t('RefCreditCard')">
                                            <b-form-input :state="getValidationState(validationContext)"
                                                label="RefCreditCard" :placeholder="$t('RefCreditCard')"
                                                v-model="sale.RefCreditCard"
                                                aria-describedby="RefCreditCard-feedback"></b-form-input>
                                ...
                                <b-col md="4" v-if="payment.Reglement == 'bank transfer'">
                                    <validation-provider name="RefTransfer"
                                        :rules="{ required: true, regex: /^\d*\.?\d*$/ }" v-slot="validationContext">
                                        <b-form-group :label="$t('RefTransfer')">
                                            <b-form-input :state="getValidationState(validationContext)"
                                                label="RefTransfer" :placeholder="$t('RefTransfer')"
                                                v-model="sale.RefTransfer"
                                                aria-describedby="RefTransfer-feedback"></b-form-input>
                                ...
                                <b-col md="4" v-if="payment.status != 'pending'">
                                    <validation-provider name="Amount" :rules="{ required: true, regex: /^\d*\.?\d*$/ }"
                                        ...
                                        <b-form-group :label="$t('Amount')">
                                            <b-form-input label="Amount" :placeholder="$t('Amount')"
                                ...
                                <b-col lg="12" md="12" sm="12" class="mt-2">
                                    <b-form-group :label="$t('BillingMethod')" v-slot="{ ariaDescribedby }">
                                        <b-form-radio v-model="BillingMethod" :aria-describedby="ariaDescribedby"
                                            name="factura" value="0">Factura</b-form-radio>
                                        <b-form-radio v-model="BillingMethod" :aria-describedby="ariaDescribedby"
                                            name="ticket" value="1">CCF</b-form-radio>
                                    </b-form-group>
                                </b-col>
                        ...
                        <b-col md="12">
                            <b-form-group>
                                <b-button variant="primary" type="submit"
                                    :disabled="paymentProcessing">{{ $t('submit') }}</b-button>
        ...
        async processPayment() {
            ...
            axios
                .post("sales", {
                    ...
                    refBankTransfer: this.sale.refBankTransfer,
