...
computed:Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(["currentUserPermissions","currentUser"]),
metaInfo:{
title:"Detail Sale"},
...
discount:0,
TaxNet:0}),
_defineProperty(_ref,"barcodeFormat","CODE128"),_defineProperty(_ref,"invoice_pos",{
sale:{
Ref:"",
client_name:"",
discount:"",
...
methods:{
keyup_Cash:function keyup_Cash(){
if(isNaN(this.payment.cash)){
this.payment.cash=0;
}
},
keyup_Change:function keyup_Change(){
...
_this2.GrandTotal=_this2.formatNumber(_this2.sale.GrandTotal,2);
_this2.payment.amount=_this2.formatNumber(_this2.sale.GrandTotal,2);
_this2.payment.Reglement="Cash";
...
this.$bvModal.show("Add_Payment");// Complete the animation of theprogress bar.
// NProgress.done();
},
...
_this4.GrandTotalText=Util.numeroALetras(_this4.formatNumber(_this4.invoice_pos.sale.GrandTotal,2));
setTimeout(function(){
// Complete the animation of the  progress bar.
nprogress__WEBPACK_IMPORTED_MODULE_2___default.a.done();

if(_this4.BillingMethod==0){
_this4.$bvModal.show("Show_invoiceF");
}else if(_this4.BillingMethod==1){
_this4.$bvModal.show("Show_invoiceF");
}
...
case 3:
_yield$_this6$stripe$=_context.sent;
...
_this6.Invoice_POS(response.data.id);
...
_this6.paymentProcessing=false;// Complete the animation of theprogress bar.
...
_this7.product.Total_price=response.data.Total_price;
...
_this7.product.product_variant_id=product.product_variant_id;
_this7.product.code=product.code;

_this7.add_product(product.code);

_this7.CaclulTotal();// Complete the animation of theprogress bar.
...
{
staticClass:
"col-3 border border-danger rounded"},

[
_c(
"span",
{staticClass:"text-danger"},
[_vm._v("Factura comercial")]),
...
{
staticClass:
"col-12 border border-primary padding-top padding-bottom"},
...
"div",
{
staticClass:"col-4 border border-primary"},
...
[_vm._v(_vm._s(_vm.sale.client_NIT))]),
...
[_vm._v(_vm._s(_vm.sale.client_NRC))])])])]),
...
_c("div",{
staticClass:"col-1 border border-primary"}),

_vm._v(" "),
_c("div",{
staticClass:"col-2 border border-primary"}),

_vm._v(" "),
_c("div",{
staticClass:"col-5 border border-primary"}),
...
"div",
{
staticClass:"col-9 border border-primary"},

[
_c(
"div",
{staticClass:"row rounded"},
[
_vm._v(
"\n                     "+
...
"div",
{
staticClass:"col-3 border border-primary"},
