...
}),_defineProperty(_objectSpread2,"performUpdateDetail",function performUpdateDetail(){
var _this4=this;
...
}),_defineProperty(_objectSpread2,"submit_Auth_Discount",function submit_Auth_Discount(){
var _this13=this;
...
axios.post("pos/authDiscount",{
authorizedCode:this.authorizedCodeIngressed}).
then(function(response){
_this13.authorizedDiscount=response.data.authorized;
console.log(_this13.authorizedDiscount);

if(_this13.authorizedDiscount>0){
_this13.performUpdateDetail();

_this13.authorizedCodeIngressed="";

_this13.$bvModal.hide("form_Auth_Discount");
}else {
...
setTimeout(function(){
_this14.payment.amount=_this14.formatNumber(_this14.GrandTotal,2);
_this14.payment.cash=_this14.formatNumber(_this14.GrandTotal,2);
_this14.payment.Reglement="Cash";// this.$bvModal.show("Add_Payment");

_this14.CreatePOS();

_this14.loading=false;// Complete the animation of theprogress bar.
...
expression:
"currentUserPermissions && !(currentUserPermissions.includes('Pos_price_edit'))"}],
...
submit:function submit($event){
$event.preventDefault();
return _vm.submit_Auth_Discount($event);
}}},
...
model:{
value:
_vm.authorizedCodeIngressed,
callback:function callback(
$$v)
{
_vm.authorizedCodeIngressed=$$v;
},
expression:
"authorizedCodeIngressed"}}),
