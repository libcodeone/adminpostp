...
_this4.makeToast("success",_this4.$t("Create.TitleCustomer"),_this4.$t("Success"));

_this4.Get_Client_Without_Paginate();

_this4.$bvModal.hide("New_Customer");
...
_this8.product.Total_price=response.data.Total_price;
...
_this8.product.product_variant_id=product.product_variant_id;
_this8.product.code=product.code;

_this8.add_product(product.code);

_this8.CaclulTotal();// Complete the animation of theprogress bar.
...
// this.products = [];
_this9.products=response.data.products;
_this9.product_totalRows=response.data.totalRows;

_this9.Product_paginatePerPage();// Complete the animation of theprogress bar.
...
_this10.sale.warehouse_id=response.data.defaultWarehouse;
_this10.sale.client_id=response.data.defaultClient;

_this10.getProducts();

_this10.paginate_Brands(_this10.brand_perPage,0);

_this10.paginate_Category(_this10.category_perPage,0);
...
setTimeout(function(){
_this11.payment.amount=_this11.formatNumber(_this11.GrandTotal,2);
_this11.payment.cash=_this11.formatNumber(_this11.GrandTotal,2);
_this11.payment.Reglement="Cash";// this.$bvModal.show("Add_Payment");

_this11.CreatePOS();// Complete the animation of theprogress bar.
