...
_c("a",{attrs:{href:"https://tecnoipsv.com/"}},[
_c("img",{
staticClass:"logo",
attrs:{
src:"/images/logo_tecnoip.png",
alt:"",
width:"60",
height:"60"}})]),
...
_vm._v(" "),
_c("p",{staticClass:"m-0"},[
_vm._v("All rights reserved - v2.4.0")])])]),
...
_vm.currentUserPermissions.includes("checkin")||
_vm.currentUserPermissions.includes("Dispatchers")),
expression:
...
"router-link",
{
attrs:{tag:"a",to:"/app/sales/list_checkin"}},
...
_vm._v(" "),
_c("span",{staticClass:"item-name"},[
_vm._v(_vm._s(_vm.$t("Dispatcher")))])])],
...
_vm._v(" "),
_vm.currentUserPermissions&&
_vm.currentUserPermissions.includes("audits")?
_c(
"li",
{staticClass:"nav-item"},
[
...
{
staticClass:"nav-item-hold",
attrs:{tag:"a",to:"/app/settings/audit"}},

[
_c("i",{staticClass:"nav-icon i-Bar-Chart"}),
_vm._v(" "),
_c("span",{staticClass:"nav-text"},[
_vm._v(_vm._s(_vm.$t("audits")))])])],
