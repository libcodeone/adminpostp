...
methods:_objectSpread(_objectSpread(_objectSpread({},Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])(["changeThemeMode","logout"])),Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(["currentUser"])),{},(_objectSpread2={
...
this.logout();
}),_defineProperty(_objectSpread2,"back",function back(){
this.$router.push({
...
}),_defineProperty(_objectSpread2,"getValidationState",function getValidationState(_ref){
...
}),_defineProperty(_objectSpread2,"Invoice_POS",function Invoice_POS(){
var _this4=this;
...
var id=this.$route.params.id;
axios.put("sales/update_to_payment/".concat(id),(_axios$put={
...
_defineProperty(_axios$put,"GrandTotal",this.payment.amount),_defineProperty(_axios$put,"statut","pending"),_axios$put)).then(function(response){
...
setTimeout(function(){
_this6.payment.amount=_this6.formatNumber(_this6.GrandTotal,2);
_this6.payment.cash=_this6.formatNumber(_this6.GrandTotal,2);
_this6.payment.Reglement="Cash";
...
_vm._v(" "),
_c("div",{staticClass:"col-4"},[
_vm.invoice_pos.big_consumer==1?
_c(
"span",
{staticClass:"h5 text-uppercase"},
[
...
_vm._e(),
_vm._v(" "),
_vm.invoice_pos.big_consumer==0?
_c(
"span",
{
staticClass:"h5 text-uppercase"},
...
_vm._e(),
_vm._v(" "),
_vm.payment.Reglement=="bank transfer"?
_c(
"b-col",
{attrs:{md:"12"}},
[
