...
//------------------------------------ Get Invoice By date -------------------------\\
Get_Invoice_By_Date:function Get_Invoice_By_Date(){
var _this5=this;

axios.get("returns/invoice/Warehouse/"+this.sale_return.warehouse_id+"/"+this.saleDate+"?stock="+0).then(function(_ref4){
var data=_ref4.data;
return _this5.invoices=data;
});
},
//----------------------------------------- Add Product -------------------------\\
...
_this8.sale_return=response.data.sale_return;
_this8.details=response.data.details;
_this8.clients=response.data.clients;
_this8.warehouses=response.data.warehouses;
_this8.saleDate=response.data.sale_return.ref_invoice_date;
_this8.idInvoice=response.data.sale_return.ref_invoice_id;//this.nameInvoice=response.data.sale_return.ref_invoice;

_this8.Get_Products_By_Warehouse(_this8.sale_return.warehouse_id);

_this8.Get_Invoice_By_Warehouse(_this8.sale_return.warehouse_id);
