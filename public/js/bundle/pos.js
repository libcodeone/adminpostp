...
}),_defineProperty(_objectSpread2,"showSidebarBrand",function showSidebarBrand(){//this.$refs.searchBrand.focus();
}),_defineProperty(_objectSpread2,"hiddenSidebarBrand",function hiddenSidebarBrand(){
this.$refs.SearchProducts.focus();
}),_defineProperty(_objectSpread2,"showSidebarCategory",function showSidebarCategory(){//this.$refs.searchCategory.focus();
