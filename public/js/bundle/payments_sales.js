...
_this.totalMount=response.data.totalSales.toFixed(2);// Complete the animation of theprogress bar.
...
[
_vm._v(
_vm._s(_vm.$t("totalPay"))+
" "+
_vm._s(_vm.totalMount.toLocaleString("en-US")))])])]),
...
_c("my-custom-filter",{
on:{input:_vm.handleCustomFilter}}):
